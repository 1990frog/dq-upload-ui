                    ...
                    <el-row class="x-row">
                        <el-col :span="10">
                            <div class="grid-content">
                                <!-- 左侧表格 -->
                                <div class="table-title">子表：{{ detailTable }}（{{ detailTableDesc }}）</div>
                                <div class="right">
                                    <el-table
                                            :data="detail"
                                            style="width: 100%"
                                ...
                                <div class="select">
                                    <el-select v-model="mainTable" placeholder="请选择" @change="tableChange" class="kyle">
                                        <el-option
                                                ...
                                                :key="index"
                                                :label="`主表：`+item.table+`（`+item.tableComment+`）`"
                                                :value="item.table"
                                                style="width:300px"
                                        ></el-option>
                                    </el-select>
    ...
    methods: {
        ...
        async queryTables() {
            this.$R.tables({
                ...
                this.tables = data;
                data.forEach(item => {
                    if (item.table === this.detailTable) {
                        this.detailTableDesc = item.tableComment;
                    }
                });
            });
        },
