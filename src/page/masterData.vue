...
<template>
  <div class="responsible">
    <el-tabs v-model="activeName" @tab-click="handleTabClick">
      <el-tab-pane label="值域字典" name="1">
        <div class="responsible-top mar-b-10">
          <div class="left">
            <el-input v-model="dictionaryKeyword" size="mini" placeholder="请输入关键字查询" clearable></el-input>
            <el-button type="primary" @click="getDictionaryTableData()" class="chaxunshuju mar-left-10" icon="el-icon-search" size="mini">
              查询
            </el-button>
          </div>
          <div class="right">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="dictionaryAdd">新增</el-button>
          </div>
        </div>
      ...
      <el-tab-pane label="明细数据" name="2">
        <div class="responsible-top mar-b-10">
          <div class="left">
            <el-input v-model="detailKeyword" size="mini" placeholder="请输入关键字查询" clearable></el-input>
            <el-button
              type="primary"
          ...
          <div class="right">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="detailAdd">新增</el-button>
            <el-button type="warning" icon="el-icon-download" size="mini" @click="openImport">导入</el-button>
          </div>
        </div>
    ...
    <el-dialog 
      ...
      top="10vh"
    >
      <el-form :model="dictionaryForm" :rules="dictionaryRules" ref="dictionaryRef" label-width="80px">
        ...
        <el-form-item label="字典类别" prop="dictType">
          <el-select v-model="dictionaryForm.dictType" placeholder="请选择字典类别" class="select-full">
            <el-option
        ...
        <!-- <el-form-item label="医疗机构" prop="hospitalCode">
          <el-select v-model="dictionaryForm.hospitalCode" placeholder="请选择医疗机构" class="select-full">
            <el-option
        ...
        <el-form-item label="开始时间" prop="startTime">
          <el-date-picker v-model="dictionaryForm.startTime" style="width:100%" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"></el-date-picker>
        </el-form-item>

        <el-form-item label="结束时间" prop="endTime">
          <el-date-picker v-model="dictionaryForm.endTime" style="width:100%" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"></el-date-picker>
        </el-form-item>
      </el-form>
    ...
    >
      <el-tabs v-model="importType">
        ...
        <el-tab-pane label="XLS文档导入" name="4">
          <div class="fileBox">
            <input ref="file" type="file" id="file" @change="handleFileInputChange" accept=".xlsx">
            <el-button type="primary" size="mini" @click="selectFile">选取文件</el-button>
            <div slot="tip" class="fileTip">只能上传.xlsx文件</div>

            <div class="fileName" v-if="fileName" @mouseenter="showCheckIcon = false" @mouseleave="showCheckIcon = true">
              <span>
...
export default {
  ...
  methods: {
    ...
    // 删除
    dictionaryDel (row) {
      this.$R.delDictionaryInfo({}, row.id).then(res => {
    ...
    downloadFormwork () {
      ...
      a.href = 'clinbrain/api/data-main/mainData/detail/download'
      a.click()
