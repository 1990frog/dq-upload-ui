        ...
        <div class="main-data">
            ...
            <el-table :data="rules" stripe class="xh-table-border1">
                ...
                <el-table-column
                        ...
                        prop="name"
                ></el-table-column>
                <el-table-column label="规则描述" prop="desc"></el-table-column>
            ...
            >
                              ...
                              <vue-slider v-model="values" tooltip="none" :process="process" :marks="marks" :min-range="5">
                                ...
                                <!-- <div class="block">
                                    ...
                                    <el-slider
                                            ...
                                            :step="10"
                                    ></el-slider>
                                    <div class="el-slider-val">{{ a[0] }} - {{ a[1] }}</div>
                                </div>
                                <div class="block">
                                    <div class="title-slider">良</div>
                                    <el-slider
                                            class="x-slider-middle"
                                            v-model="b"
                                            range
                                            show-stops
                                            :min="0"
                                            ...
                                            :step="10"
                                    ></el-slider>
                                    <div class="el-slider-val">{{ b[0] }} - {{ b[1] }}</div>
                                </div>
                                <div class="block">
                                    <div class="title-slider">中</div>
                                    <el-slider
                                            class="x-slider-low"
                                            v-model="c"
                                            range
                                            ...
                                            :step="10"
                                    ></el-slider>
                                    <div class="el-slider-val">{{ c[0] }} - {{ c[1] }}</div>
                                </div>
                                <div class="block">
                                    <div class="title-slider">差</div>
                                    <el-slider
                                            class="x-slider-lowest"
                                            v-model="d"
                                            range
                                            show-stops
                                            :min="0"
                                            ...
                                            :step="10"
                                    ></el-slider>
                                    <div class="el-slider-val">{{ d[0] }} - {{ d[1] }}</div>
                                </div> -->
                            </div>
                        </el-col>
                    </el-row>
                ...
                <main v-show="flag === 'source'">
                    ...
                    <el-row>
                        ...
                        <el-col :span="18">
                            <el-input v-model="desc" placeholder="请输入描述内容"></el-input>
                        </el-col>
                    </el-row>
                    <el-row>
...
export default {
    ...
    methods: {
        ...
        handleEdit(index, row) {
            this.id = row.id;
            this.checkRule = row.key;
            this.getRuleInfo(row.key);
        },
        getRuleInfo(rule) {
            let that = this;
            that.$R
        ...
        async saveRule() {
            ...
            let param = {
                id: this.id,
                rule: this.checkRule,
                ruleCategoryId: this.checkRuleId,
        ...
        // saveQLJC(row){
        //     let that = this;
        //     this.$R.savefulledittime({
        //         endTime:row.timeRange[1] + ' 23:59:59',
        //         hospital:row.hospital,
        //         rule:that.fullexec_type,
        //         startTime:row.timeRange[0] + ' 00:00:00',
        //         table:row.tableName,
        //         type:row.type
        //     })
        //
        ...
        //     let res = await this.$R.currencyruleinfo({
        //         keyword: '',
        //         type: 'hospital'
        //     });
        //
        ...
        // async implementRule() {
        //     // 提交执行数据
        //     await this.postRuleField();
        //
        //     // 请求列表数据
        //     let that = this;
        //     await this.getYMQLJCData({
        //         rule:that.fullexec_type
        //     })
        //     // return
        //     //  this.getYMQLJCData()
        ...
        // async cancel(){
        //     let pidlist = [];
        //     this.fullexec_table.forEach((item,index) => {
        //         if(item.pid != null){
        //             pidlist[index] = item.pid
        //         }
        //     })
        //     if(pidlist.length === 0){
        //         return false;
        //     }
        //     let res = await this.$R.cancelexec({
        //         pid: pidlist
        //     });
        //     if(res.code === 200){
        //         // 请求列表数据
        ...
        // 选择全量的数据：val 获取的选择的条数
        // getSelectRuleField(val) {
        //     console.log(val);
        //     this.fullexec_table = val;
        // },

        // // 提交运行全量规则的数据
        // async postRuleField() {
        //     console.log(this.fullexec_table);
        //
        //     let listData = [];
        //     this.fullexec_table.forEach((item,index) => {
        //         listData[index] = {}
        //         listData[index].table = item.tableName
        //         listData[index].hospital = item.hospital
        //         listData[index].type = item.type
        //     })
        //     console.log(listData)
        //     let that = this;
        //     let res = await this.$R.fullexec({
        //         hospital: that.hospitalValue,
        //         list: listData,
        //         rule:that.fullexec_rule,
        //         time:that.runtime
        //     });
        //
        //     this.$message({
        ...
        // // 查询--源目检测的信息
        // setYMQLJCSearchRes() {
        //     // this.ymqljc_search  输入的文本内容
        //     let that = this;
        //     this.getYMQLJCData({
        //         keyword: that.ymqljc_search,
        //         rule:that.fullexec_type
        //     });
        // },
        //
        // // 请求源目全量检测
        // async getYMQLJCData(obj = {}) {
        //     let res = await this.$R.totalrule({
        //         num: obj.num || 1,
        //         size: obj.size || 10,
        //         rule: obj.rule,
        //         keyword: obj.keyword || ''
        //     });
        //
        //     this.ymqljc_data_total = res.total - 0;
        //     this.ymqljc_table_data = res.list;
        // },
        //
        // // 显示全量检测
        // showQuanLiang(index, row) {
        //     this.fullexec_rule = row.type
        //     // 源目、主子、枚举值、绝对值暂时没有数据。
        //     if (row.type === '源目检测' || row.type === '主子关系检测' || row.type === '枚举值检测' || row.type === '绝对值检测') {
        //         console.log(index, row.type);
        //         // 设置当前的规则类型，用于后面执行时使用
        //         this.fullexec_type = row.type;
        //
        //         // 显示弹窗
        //         this.YMQLJC_Dialog = true;
        //
        //         // 请求配置字段的列表
        //         this.getYMQLJCData({
        //             rule: row.type
        ...
        //     } else {
        //         this.$message({
        //             message: row.type + '暂时没有数据，请选择：源目检测/主子关系检测/枚举值检测/绝对值检测。',
        //             type: 'warning'
        //         });
        //     }
        // },
        ...
        // 输入框失去焦点或用户按下回车时触发
        // changeIncrementDay(val) {
        //     console.log(val);
        //     console.log('输入框失去焦点或用户按下回车时触发');
        //     let that = this;
        //
        //     // 提交数据保存
        //     this.$confirm('增量检测区间是否确认修改？', '提示', {
        //         confirmButtonText: '确定',
        //         cancelButtonText: '取消',
        //         type: 'warning'
        //     })
        //         .then(() => {
        //             // that.saveTotalQuantity();
        //         })
        //         .catch(() => {
        //             isSetDate = false;
        //             // this.$message({
        ...
        /*
         * 激活日期控件触发事件
         * 激活日期控件之后，改变hoverTdId的值，避免选择日期时。td的内容改变
         */
        // setTableHoveId() {
        //     isSetDate = true;
        // },
        ...
        // 移入table-td 触发的事件
        // setTableTime(row, column, cell, event) {
        //     console.log(row.dateRange);
        //     temporaryDay = row.dateRange;
        //     if (isSetDate) {
        //         return;
        //     }
        //
        //     if (column.label === '自定义检测区间') {
        //         this.hoverTdId = row.id;
        //         this.date_picker_total[0] = row.startTime || '';
        //         this.date_picker_total[1] = row.endTime || '';
        //         this.TotalQuantityId = row.id;
        //         this.TotalQuantityDay = row.dateRange;
        //     }
        //
        //     if (column.label === '增量检测区间') {
        //         this.hoverIncrement = row.id;
        //         this.date_picker_total[0] = row.startTime || '';
        //         this.date_picker_total[1] = row.endTime || '';
        //         this.TotalQuantityId = row.id;
        //     }
        ...
        //
        // // 滑离table-td触发的事件
        // postTableTime(row, column, cell, event) {
        //     console.log(row.dateRange);
        //     if (isSetDate) {
        //         return;
        //     }
        ...
        //     }
        //
        //     // 如果滑离的是增量检测区间，那么现实修改的状态
        //     if (column.label === '增量检测区间') {
        //         this.hoverIncrement = -1;
        //
        //         // 验证td中的天数是否修改
        //         if (temporaryDay !== row.dateRange) {
        //             // 弹窗提示用户是否保存修改
        ...
        //         }
        //     }
        //     // console.log(row,column.level,cell,event);
        // },
        //
        // // 保存增量检测区间的天数
        // async saveIncrementDay(row) {
        //     let res = await this.$R.postDaterange({
        //         id: row.id,
        ...
        //     console.log(res);
        //
        //     console.log('增量区间天数保存成功');
        // },
        //
        // // 选择大于、小于状态改变，验证是否需要数字
        // changeFanwei(e) {
        //     // console.log(e);
        //     if (e === '存在' || e === '不存在') {
        //         // 数字按钮dis
        ...
        // getSearchRes() {
        //     this.getTypeList(this.searchInput);
        // },

        // // 保存全量时间
        // async saveTotalQuantity() {
        //     let that = this;
        //
        //     let res = await this.$R.postDaterange({
        //         endTime: that.date_picker_total[1] + ' 23:59:59',
        //         id: that.TotalQuantityId,
        //         startTime: that.date_picker_total[0] + ' 00:00:00'
        //     });
        //
        //     // 更新全量信息之后，更新table数据
        //     this.getTypeList();
